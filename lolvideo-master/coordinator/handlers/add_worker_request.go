...
func (h *LolVideoHandler) HandleAddWorkerRequest() func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		spotPrices, _ := coordinator.GetSpotPrices(awsClient, coordinator.Ec2WorkerInstanceTypeVideogen)
		...
		t, err := template.ParseFiles(coordinator.CoordinatorTemplatesDir + "/addWorker.html")
		if err != nil {
			log.Fatalln(err)
		}
		t.Execute(w, context)

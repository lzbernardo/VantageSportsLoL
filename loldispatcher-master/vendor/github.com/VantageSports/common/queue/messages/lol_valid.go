...
func (rq *LolGoalsUpdate) Valid() error {
	if rq.MatchId == 0 || rq.PlatformId == "" || rq.SummonerId == 0 || rq.RolePosition == "" {
		return fmt.Errorf("match_id, platform_id, summoner_id, role_position required")
	}
	return nil
}
